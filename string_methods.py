...
def count_repetition(a_string, a_substring):
    ...
    # TODO: return how many times a_substring occurs in a_string
...
def is_a_question(a_string):
    if "?" in a_string:
        return True
    return False
    # TODO: return true if a_string ends with a "?"
...
def full_description_concatenation(first_name, last_name, age):
    ...
    # TODO: return a sentence with the first_name and the last_name capitalized and the age
